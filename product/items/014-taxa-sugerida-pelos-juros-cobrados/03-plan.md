...
- [ ] `comando` — RF-01, RF-03, RF-07, RF-08
      ...
      igual a `7`; e uma chamada `CAIXA`, com `median_bp` igual a `804` e
      `months` igual a `4`
- [ ] `comportamental` — RF-09, RF-10
      ...
      *Então* a resposta é `200`; o bloco `id="sem-taxa"` traz **exatamente
      dois** elementos com `data-sugerida`, com os valores `422` e `804` e os
      `data-faixa` `210-680` e `383-1153`; o campo de taxa da linha do `itau` vem
...
- [ ] `comando` — RF-12
      `rtk proxy grep -REn --exclude-dir=__pycache__ "\b(422|804|210|680|383|1153)\b"
