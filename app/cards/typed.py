...
def parse(unit: str, typed: str, field: str) -> int | None:
    # Decision: blank is not this function's business anymore;
    # app.cards.store.write intercepts it before calling parse, because
    # that decision (leave it alone, RF-01) belongs to the writer, not to
    # the reader.
