...
def system_prompt(today: date, categories: list[str]) -> str:
    ...
    return (
        ...
        "recorrente nos próximos meses e o que termina quando: commitments_by_month. Quanto custa "
        "quitar uma dívida, quanto juntar por mês para quitá-la até uma data ou quando dá para "
        "quitar guardando um valor por mês: debt_payoff, primeiro sem debt para achar a chave. "
        "Se ela disser que o saldo de quitação não foi informado, diga isso, dê a soma das "
        "parcelas que faltam como teto e nunca estime desconto de juros. Quais dívidas quitar "
        "para liberar dinheiro no mês, ou o que quitar com um valor disponível: "
        "debts_by_liquidity, na ordem que ela devolve; diga 'estimativa pelo teto' onde ela "
        "marcar. Peça tudo "
