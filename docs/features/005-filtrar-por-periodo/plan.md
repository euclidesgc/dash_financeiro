...
- [ ] T2.1 — Tipos, utilitário puro de período, chamada de API com `from`/`to` e mock que filtra
...
- [ ] T2.2 — `PeriodControls`, `SortControls` sem a barra e a receita "Grupo de período"
...
- [ ] T2.3 — Período na URL em `ExpensesList`, barra única de controles, vazio filtrado e total no resumo
