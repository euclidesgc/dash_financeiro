...
- [x] T1.1 — Mover `_fill_payees` para a carga, gravando `NULL` para vazio, e tirá-la da classificação
...
- [x] T1.2 — Roadmap: linhas 024 e 032 no presente
