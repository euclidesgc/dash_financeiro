...
- [x] T2.1 — Tipos, chamada de API com `URLSearchParams` e mock que ordena
...
- [x] T2.2 — `SortControls` e a receita "Barra de controles de lista"
...
- [x] T2.3 — Ordenação na URL em `ExpensesList` e texto de apoio da rota
...
- [x] T2.4 — Backend do e2e com dois gastos distinguíveis e jornada Playwright de ordenação
...
- [x] CA2.10 — `tests/data/e2e_transactions.json` tem quatro objetos; o quarto tem `"id": "e2e-t-4"`, `"descricao": "POSTO CENTRAL"`, `"valor": -150.0`, `"data": "2026-09-01"`, `"categoria": "Housing"` e `"conta_id": "acc-fixture-1"`. (estrutural)
